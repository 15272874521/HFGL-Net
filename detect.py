...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/fqy/yolov5/yolov5_obb-master/runs/train/exp16/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='/data0/fqy/DOTA_SS/test/images/', help='file/dir/URL/glob, 0 for webcam')
